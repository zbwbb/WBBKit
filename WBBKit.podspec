#
#  Be sure to run `pod spec lint WBBKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/zbwbb/WBBKit.git", :tag => "#{s.version}" }
...
# ――― Subspec ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  ...
  s.subspec 'Util' do |ss|
    ss.source_files = 'Util/ZCPUtil.{h,m}'
